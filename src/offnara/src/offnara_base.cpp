    ...
    heading_(0)
{
    ...
    velocity_subscriber_ = nh_.subscribe("raw_vel", 50, &offnaraBase::velCallback, this);
}

void offnaraBase::velCallback(const offnara_msgs::Velocities& vel)
{
